...
extern "C"
{
	...
	typedef enum
	{
		 ...
		 */
		DJI_FC_SUBSCRIPTION_TOPIC_STATUS_MOTOR_START_ERROR = DJI_DATA_SUBSCRIPTION_TOPIC(DJI_DATA_SUBSCRIPTION_MODULE_FC, 31),
		/*!
		 ...
		 */
		DJI_FC_SUBSCRIPTION_TOPIC_BATTERY_SINGLE_INFO_INDEX1 = DJI_DATA_SUBSCRIPTION_TOPIC(DJI_DATA_SUBSCRIPTION_MODULE_FC, 46),
		/*!
		 * @brief Battery information topic name. Please refer to ::T_DjiFcSubscriptionSingleBatteryInfo for information about data structure.
		 * @datastruct \ref T_DjiFcSubscriptionSingleBatteryInfo
		 */
		DJI_FC_SUBSCRIPTION_TOPIC_BATTERY_SINGLE_INFO_INDEX2 = DJI_DATA_SUBSCRIPTION_TOPIC(DJI_DATA_SUBSCRIPTION_MODULE_FC, 47),
	...
	typedef enum
	{
		...
		DJI_FC_SUBSCRIPTION_GPS_FIX_STATE_2D_FIX =
			2, /*!< The horizontal position with latitude/longitude (or northing/easting or X/Y) is fixed. */
		DJI_FC_SUBSCRIPTION_GPS_FIX_STATE_3D_FIX =
			3, /*!< The horizontal and vertical position with latitude/longitude/altitude (northing/easting/altitude or X/Y/Z) is fixed. */
	...
	typedef enum
	{
		...
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_VEL_YAW_ANG =
			1,	/*!< Horizontal mode is angle, vertical mode is velocity, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_VEL_YAW_RAT =
			2,	/*!< Horizontal mode is angle, vertical mode is velocity, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_VEL_YAW_ANG =
			3,	/*!< Horizontal mode is velocity, vertical mode is velocity, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_VEL_YAW_RAT =
			4,	/*!< Horizontal mode is velocity, vertical mode is velocity, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_VEL_YAW_ANG =
			5,	/*!< Horizontal mode is position, vertical mode is velocity, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_VEL_YAW_RAT =
			6,	/*!< Horizontal mode is position, vertical mode is velocity, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_POS_YAW_ANG =
			7,	/*!< Horizontal mode is angle, vertical mode is position, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_POS_YAW_RAT =
			8,	/*!< Horizontal mode is angle, vertical mode is position, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_POS_YAW_ANG =
			9,	/*!< Horizontal mode is velocity, vertical mode is position, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_POS_YAW_RAT =
			10, /*!< Horizontal mode is velocity, vertical mode is position, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_POS_YAW_ANG =
			11, /*!< Horizontal mode is position, vertical mode is position, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_POS_YAW_RAT =
			12, /*!< Horizontal mode is position, vertical mode is position, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_THR_YAW_ANG =
			13, /*!< Horizontal mode is angle, vertical mode is thrust, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_ANG_VER_THR_YAW_RAT =
			14, /*!< Horizontal mode is angle, vertical mode is thrust, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_THR_YAW_ANG =
			15, /*!< Horizontal mode is velocity, vertical mode is thrust, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_VEL_VER_THR_YAW_RAT =
			16, /*!< Horizontal mode is velocity, vertical mode is thrust, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_THR_YAW_ANG =
			17, /*!< Horizontal mode is position, vertical mode is thrust, yaw mode is angle. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_POS_VER_THR_YAW_RAT =
			18, /*!< Horizontal mode is position, vertical mode is thrust, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_AEL_VER_VEL_YAW_RAT =
			19, /*!< Horizontal mode is angle-rate, vertical mode is velocity, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_AEL_VER_POS_YAW_RAT =
			20, /*!< Horizontal mode is angle-rate, vertical mode is thrust, yaw mode is rate. */
		DJI_FC_SUBSCRIPTION_CONTROL_MODE_HOR_AEL_VER_THR_YAW_RAT =
			21, /*!< Horizontal mode is angle-rate, vertical mode is velocity, yaw mode is rate. */
	...
	typedef enum
	{
		...
		DJI_FC_SUBSCRIPTION_AUTHORITY_CHANGE_REASON_RC_ONE_KEY_GO_HOME =
			8,														   /*!< Contro authority changed for remote control go-home key paused. */
		DJI_FC_SUBSCRIPTION_AUTHORITY_CHANGE_REASON_BATTERY_LOW_GO_HOME =
			9,														   /*!< Contro authority changed for remote control go-home key paused. */
		DJI_FC_SUBSCRIPTION_AUTHORITY_CHANGE_REASON_BATTERY_SUPER_LOW_LANDING =
			10, /*!< Contro authority changed for going home caused by low batter power. */
	...
	{
		dji_f32_t
			hdop; /*!< Horizontal dilution of precision, unit: 0.01, eg: 100 = 1.00, <1: ideal, 1-2: excellent, 2-5: good, 5-10: moderate, 10-20: fair, >20: poor. */
		dji_f32_t
			pdop; /*!< Position dilution of precision, unit: 0.01, eg: 100 = 1.00, <1: ideal, 1-2: excellent, 2-5: good, 5-10: moderate, 10-20: fair, >20: poor. */
		dji_f32_t
			fixState; /*!< GPS fix state, and can be any value of ::E_DjiFcSubscriptionGpsFixState. Value other than ::E_DjiFcSubscriptionGpsFixState is invalid. */
