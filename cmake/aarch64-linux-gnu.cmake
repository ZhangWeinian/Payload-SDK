...
if(CMAKE_HOST_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64|ARM64)$")
    ...
    find_program (_aarch64_cross_gxx aarch64-linux-gnu-g++)
    if(NOT _aarch64_cross_gxx)
        message (
            FATAL_ERROR "当前宿主是 ${CMAKE_HOST_SYSTEM_PROCESSOR}，arm-release 产出的是 aarch64 二进制，"
                        "需要 aarch64-linux-gnu-g++ 交叉编译器，本机未安装。\n" "请改用：debug / asan / tsan / cov / perf / fuzz（与平台无关）。"
        )
    endif()
