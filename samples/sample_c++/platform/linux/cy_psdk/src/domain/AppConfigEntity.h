...
namespace plane::domain
{
    struct AppConfigEntity
    {
        ...
        ::std::string                local_uuid { "" };                            // 本地默认 uuid
        ::std::string                simulator_default_longitude { "118.892591" }; // 模拟器默认经度
        ::std::string                simulator_default_latitude { "32.067228" };   // 模拟器默认纬度
        ::std::string                simulator_default_gps_count { "15" };         // 模拟器默认卫星数量
        ::std::string                last_used_plane_code { "" };                  // 上次使用的飞机编号
        ::std::string                registry_ip { "127.0.0.1" };                  // 默认注册服务地址
        ::std::string                catalog_node_id { "" };                       // 当前选中的 Catalog nodeId
        ::std::vector<::std::string> catalog_targets {};                           // 当前选中节点的探测目标
