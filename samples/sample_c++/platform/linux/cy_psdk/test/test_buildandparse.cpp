...
TEST(JsonConverter, BuildStatusReportEnvelope)
{
    ...
    EXPECT_EQ(parsed.at("ZBID").get<::std::string>(), "0A1B2C3D4E5F6078");
...
TEST(JsonConverter, BuildMissionInfoEnvelope)
{
    ...
    EXPECT_EQ(parsed.at("XXXX").at("FJSN").get<::std::string>(), "0A1B2C3D4E5F6078");
...
TEST(JsonConverter, ParseAndRouteDispatchesMatchingPlane)
{
    ...
    const ::std::string message { R"({"ZBID":"0A1B2C3D4E5F6078","XXLX":"SBZT","XXXX":{"DQJD":116.39,"YTFY":-5.0}})" };
